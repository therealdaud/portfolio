...
const projects: Project[] = [
  ...
  },
  {
    name: 'QuietSpot',
    emoji: '🎙️',
    tagline: 'Crowdsourced Noise Monitor App',
    period: 'Jan 2025 – Mar 2025',
    description: 'A React Native Android app that lets users record ambient noise levels via their device microphone and pin them on a live map, creating a crowd-sourced database of quiet locations for students and individuals with noise sensitivity.',
    bullets: [
      'Built with React Native and a Node.js/Express backend where users submit noise readings (latitude, longitude, dB level, title, description) via REST API that are validated and persisted to MongoDB Atlas in the cloud.',
      'Integrated device microphone for real-time 15-second dB averaging with calibration, and Google Maps API to render GPS-pinned community markers showing crowd-sourced noise averages and notes at each location.',
      'Designed the data schema with 5 core geospatial fields stored in MongoDB Atlas, enabling location-based queries to surface the nearest quiet spots and support data-driven recommendations for hyperacusis patients.',
      'Shipped a live web companion on Vercel alongside the mobile app, expanding reach beyond Android to any browser user looking to find or contribute quiet spot data.',
    ],
    tech: ['React Native', 'Expo', 'Node.js', 'Express', 'MongoDB Atlas', 'Google Maps API', 'REST API'],
    color: '#00d4ff',
